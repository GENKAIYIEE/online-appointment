            ...
            {calendarDays.map((day, idx) => {
              ...
              if (!isCurrentMonth) {
                ...
                if (isFetchingMonth) {
                  ...
                  const { available, total, booked, isDoctorOnLeave } = daySummary;
                  ...
                  if (isDoctorOnLeave) {
                    content = (
                      <div className="flex justify-center mt-3">
                        <div className="rounded-[20px] px-2 sm:px-[12px] py-[2px] sm:py-[4px] text-[10px] sm:text-[12px] font-medium border text-center leading-tight bg-[#FEF2F2] text-[#EF4444] border-[#FECACA]">
                          Doctor on leave
                        </div>
                      </div>
                    );
